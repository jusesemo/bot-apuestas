...
for partido in partidos:
    ...
    # NUEVO FILTRO DE CALIDAD POR NOMBRES SOSPECHOSOS
    ...
    if any(x in texto for x in bloquear_fuertes):
        continue

    # NUEVO FILTRO DE LIGAS BASURA (MUY PODEROSO)
    bloquear_ligas = [
        "REGIONAL", "TERCERA", "CUARTA",
        "DIVISION 3", "DIVISION 4", 
        "AMATEUR", "LOCAL"
    ]
    
    if any(x in texto for x in bloquear_ligas):
        continue
